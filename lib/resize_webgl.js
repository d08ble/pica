...
function convolve(gl, texUnit0, texWidth, texHeight, texUnit, fsh, winSize, destW, destH, flipY) {
...
function webglProcessResize(from, gl, options) {
  ...
  if (winSize < 2) winSize = 2;

  var texUnit2 = 2;
  var texUnit3 = 3;

  convolve(gl, texUnit0, srcW, srcH,
    texUnit2, '#fsh-lanczos-1d-covolve-horizontal', winSize, dstW, srcH, false);

  var finalFboObject = convolve(gl, texUnit2, dstW, srcH,
    texUnit3, '#fsh-lanczos-1d-covolve-vertical', winSize, dstW, dstH, true);
